...
import com.yk.modules.sys.shiro.RedisShiroSessionDAO;
import com.yk.modules.sys.shiro.UserRealm;
...
public class ShiroConfig {
    ...
    public SessionManager sessionManager(RedisShiroSessionDAO redisShiroSessionDAO,
                                         @Value("${yk.redis.open}") boolean redisOpen,
                                         @Value("${yk.shiro.redis}") boolean shiroRedis){
